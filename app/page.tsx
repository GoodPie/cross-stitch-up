...
import type { StitchConfig, PageRenderResult, GridArrangement } from "@/lib/pdf/types"

export type AppState = "config" | "upload" | "selecting" | "processing" | "success" | "error"
...
export default function Home() {
  ...
  const handleMerge = useCallback(async (arrangement: GridArrangement) => {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <main className="flex-1 container max-w-5xl mx-auto px-4 py-8 md:py-12">
        {appState === "config" && <StitchConfigForm onContinue={handleConfigContinue} />}
        {appState === "upload" && (
        ...
        {appState === "success" && result && <ResultsState result={result} onReset={handleReset} />}
        {appState === "error" && (
          <div className="text-center space-y-4">
            ...
            <h2 className="text-xl font-serif font-semibold text-foreground">Oops! Something went wrong</h2>
