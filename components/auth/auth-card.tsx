    ...
    return (
        <div className="from-background via-background to-muted/30 flex min-h-screen flex-col items-center justify-center bg-linear-to-br px-4 py-8">
            <Link href="/" className="mb-8 flex items-center gap-3 transition-opacity hover:opacity-80">
                ...
                <div>
                    <h1 className="text-foreground font-serif text-2xl font-bold">Cross Stitch-up</h1>
                    <p className="text-muted-foreground text-xs">Tools for cross stitch enthusiasts</p>
                </div>
            </Link>
